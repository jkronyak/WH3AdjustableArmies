...
-- [Settings] --
local settings = {army_size = 40, auto_refresh = true, dev_logging = false, ai_army_size = 40, force_siege_assault = true, force_siege_assault_turns = 3}
...
function init_addresses()
    ...
    exchange_panel_ui_offset = 0x208C09C
    player_army_size_offset = 0x20CB64C
